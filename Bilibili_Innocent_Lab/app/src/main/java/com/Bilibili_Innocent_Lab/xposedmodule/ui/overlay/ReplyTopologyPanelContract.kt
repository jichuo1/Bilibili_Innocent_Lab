...
internal data class ReplyTopologyPanelStrings(
    ...
    val nodeActionDescription: String,
    val locateReplyAction: String,
    ...
    val locateSuccessMessage: String,
    val locateThreadOnlyMessage: String,
    val locateUnsupportedMessage: String,
    val locateUnavailableMessage: String,
    val locateFilteredMessage: String,
    ...
    companion object {
        ...
        private val SIMPLIFIED_CHINESE = ReplyTopologyPanelStrings(
            ...
            nodeActionDescription = "点击选择，可通过操作菜单定位完整评论",
            locateReplyAction = "定位完整评论",
            expandPanel = "展开",
            ...
            locateSuccessMessage = "已定位到完整回复",
            locateThreadOnlyMessage = "已打开评论详情，但未找到目标回复",
            locateUnsupportedMessage = "当前哔哩哔哩版本暂不支持精确定位",
            locateUnavailableMessage = "该回复已删除、不可见或尚未加载",
            locateFilteredMessage = "该回复被当前评论过滤规则隐藏，无法定位",
        ...
        private val TRADITIONAL_CHINESE = ReplyTopologyPanelStrings(
            ...
            nodeActionDescription = "點按選取，可透過操作選單定位完整評論",
            locateReplyAction = "定位完整評論",
            expandPanel = "展開",
            ...
            locateSuccessMessage = "已定位到完整回覆",
            locateThreadOnlyMessage = "已開啟評論詳情，但找不到目標回覆",
            locateUnsupportedMessage = "目前嗶哩嗶哩版本暫不支援精確定位",
            locateUnavailableMessage = "此回覆已刪除、不可見或尚未載入",
            locateFilteredMessage = "此回覆被目前評論篩選規則隱藏，無法定位",
        ...
        private val ENGLISH = ReplyTopologyPanelStrings(
            ...
            nodeActionDescription = "Activate to select; use the actions menu to locate the full reply",
            locateReplyAction = "Locate full reply",
            expandPanel = "Open",
            expandDescription = "Expand reply context panel",
            ...
            locateSuccessMessage = "Full reply located",
            locateThreadOnlyMessage = "Comment details opened, but the target reply was not found",
            locateUnsupportedMessage = "Precise locating is unavailable in this Bilibili version",
            locateUnavailableMessage = "This reply is deleted, unavailable, or not loaded yet",
            locateFilteredMessage = "This reply is hidden by the current comment filters and cannot be located",
...
internal interface ReplyTopologyPanelListener {
    ...
    fun onNodeLocateRequested(rpid: Long) = Unit
