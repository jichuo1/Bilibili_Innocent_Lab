 ...
 *   - Intent.setClassName("Bilibili_Innocent_Lab.pro", 本类全名)
...
class FreeCopyActivity : AppViewsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val predictiveBackEnabled = runCatching {
            prefs().getBoolean(Bilibili_Innocent_Lab.pro.hook.HookEntry.PREF_PREDICTIVE_BACK_ENABLED, false)
        }.getOrDefault(false)
        Bilibili_Innocent_Lab.pro.ui.PredictiveBack.apply(window, predictiveBackEnabled)
