...
object RoamingCompatHook {
    ...
    const val PROVIDER_AUTHORITY = "Bilibili.Innocent_Lab.pro.roaming"

    /** 模块 App 开关变化时向 B 站发送的显式广播（B 站进程内由 HookEntry 注册接收） */
    const val ACTION_SET_ROAMING_COMPAT = "Bilibili.Innocent_Lab.pro.SET_ROAMING_COMPAT"
    ...
    private fun openRoamingSettings(context: Context) {
        ...
        runCatching {
            val intent = Intent(Bilibili_Innocent_Lab.pro.receiver.RoamingOpenReceiver.ACTION_OPEN_ROAMING_SETTINGS)
                .setPackage("Bilibili_Innocent_Lab.pro")
