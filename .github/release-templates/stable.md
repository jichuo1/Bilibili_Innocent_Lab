...
<!-- 用 2～4 句话说明本版本的主要目标和用户收益，发布前删除本注释。 -->
...
| 文件 | 用途 | SHA-256 |
| --- | --- | --- |
| `Bilibili_Innocent_Lab-{{VERSION}}.apk` | 模块安装包 | `{{APK_SHA256}}` |
